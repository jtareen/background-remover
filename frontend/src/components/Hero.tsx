      ...
      >
        ...
        >
          <div className="flex flex-col items-center text-center space-y-4">
            <h1
              className={cn(
                "font-spectral text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight",
                titleClassName,
              )}
            >
              {title}
        ...
        <ImageDivider
            before="/samples/demo-cup.jpeg"
            after="/samples/no-bg-cup.png" 
            className="aspect-4/4 rounded-xl hidden lg:grid w-40 xl:w-50 absolute top-1/2 left-4/5 -translate-y-1/2 -translate-x-5 xl:-translate-x-0 rotate-14 shadow-xl"
        />
        <ImageDivider
            before="/samples/demo-apple.jpg"
            after="/samples/no-bg-apple.png" 
            className="aspect-4/4 rounded-xl hidden lg:grid w-30 xl:w-40 absolute top-1/2 right-4/5 translate-y-1/2 -rotate-18 shadow-xl"
        />
      </section>
    )
  },
